...
// Subcategories for each category — used to filter products by subcategory
// URL pattern: /shop?category=electronics&subcategory=headphones
...
// Usage: getSubcategories('electronics') → [{ id, label }, ...]
...
export const getCategoryItems = (receivedCategory, receivedSubcategory) =>
  mockProducts.filter((prodObj) => {
    const matchesCategory = receivedCategory
      ? prodObj.category === receivedCategory
      : true;
    const matchesSubcategory = receivedSubcategory
      ? prodObj.subcategory === receivedSubcategory
      : true;
